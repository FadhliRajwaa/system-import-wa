<div class="space-y-6 animate-fade-in-up">
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="space-y-1">
            ...
            <p class="text-slate-500 dark:text-slate-400 ml-0 sm:ml-15">Lengkapi data paket baru</p>
        </div>
    </div>
        ...
        <div class="p-6 sm:p-8">
            <div class="max-w-xl space-y-6">
                ...
                <div class="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-6 border-t border-slate-100 dark:border-slate-800">
                    ...
                    <flux:button variant="primary" wire:click="save" icon="check" class="shadow-xl shadow-cyan-500/25">
                        Simpan Paket
                    </flux:button>
                </div>
            </div>
